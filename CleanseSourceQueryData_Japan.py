...
data_path = 'c:/$user/PythonScripts/ModelFactoryData/Japan/'
file_in =  'HistoricalData_Japan_Raw_01Dec15-30Apr16.csv'
file_out = 'HistoricalData_Japan_Clean_01Dec15-30Apr16.csv'
...
OutputData['DealAgogSpPrice']=InputData1['AGOGSPECIAL'] 
...
# InputData1['COM_DELEGATEDLEVEL']='QF' then 1 in below columns else 0
OutputData['DelegLvl=QF']=InputData1['COM_DELEGATEDLEVEL'].str.strip().isin(['QF']).astype(int)
# InputData1['COM_UPGRADEFLAG']='4' then 1 in below columns else 0
OutputData['UpgrdFlag=4']=InputData1['COM_UPGRADEFLAG'].str.strip().isin(['4']).astype(int)
